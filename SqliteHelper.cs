...
namespace DataSave
{
    ...
    {
        private const string checkTags = "checkTags: SqliteHelper:\t";

        private const string database_name = "gamedb.db";
        ...
        public SqliteHelper()
        {
            if (!File.Exists(db_connection_string))
            {
        ...
        {
            Debug.Log(checkTags + "This function is not implemnted");
            throw null;
        }
        ...
        {
            Debug.Log(checkTags + "This function is not implemented");
            throw null;
        }
